...
class dznvBlox:
    ...
    def __init__(self):
        if os.path.exists(os.path.join(tempfile.gettempdir(), "dznvBlox_data")):
    ...
    def _Update(self):
        ...
        if self._CheckUpdate():
            ...
            copy("https://github.com/unknownperson-vos/dznvBlox")
            messagebox.showinfo("dznvBlox","NEW Update Found ! Github's link copied automatically. Simply paste the link in your browser and download the latest version by clicking on the button 'download latest'. Enjoy")
    ...
    def _RestoreBackups(self):
        ...
        backup_root = os.path.join(temp_dir, "dznvBlox_data")
        data_root = "data"
    ...
    def _QuarantineInstallers(self):
        ...
        quarantine_base = os.path.join(tempfile.gettempdir(), "dznvBlox_Quarantine")
        ...
        try:
            ...
            threading.Thread(target=self._UpdateLogs,args=("[SUCCESS] RobloxPlayerInstaller.exe quarantined to TEMP while dznvBlox is open",)).start()
        except Exception:
    ...
    def _RestoreInstallers(self):
        versions_path = os.path.join(os.getenv("LOCALAPPDATA"), "Roblox", "Versions")
        quarantine_path = os.path.join(tempfile.gettempdir(), "dznvBlox_Quarantine")
    ...
    def _RobloxInfor(self,userid,pid,found):
        try:
            ...
            threading.Thread(target=self._UpdateLogs, args=(f"[FAILED] Could not fetch roblox profile because user id was not found (this doesnt affect dznvblox)",)).start()
    ...
    def _ProcessInformation(self,name,userid,pic,text,pid):
        ...
        self.processinfogui.title("dznvBlox (Process Information)")
    ...
    def _Settings(self):
        ...
        self.settingsgui.title("dznvBlox (Settings)")
    ...
    def _Support_DiscordLink(self):
        copy("https://discord.gg/Sv3Vem5NCT")
        messagebox.showinfo("dznvBlox","Discord link copied to clipboard ! Simply paste on discord to join")
    def _Support(self):
        self.supportgui = Toplevel(window)
        self.supportgui.title("dznvBlox (Support)")
    ...
    def _Documentation(self):
        ...
        self.documengui.title("dznvBlox (Documentation)")
    ...
    def _Donations_BTC(self):
        ...
        messagebox.showinfo("dznvBlox","Bitcoin Address Copied !")
    def _Donations_ETH(self):
        copy("0xb89E00a5C4d73239697470B6415f65671F4beb2D")
        messagebox.showinfo("dznvBlox","Ethereum Address Copied !")
    def _Donations_LTC(self):
        copy("LSkcr4zrSM2kF6W19F6VMi7ic2nSEAoibY")
        messagebox.showinfo("dznvBlox","Litecoin Address Copied !")
    def _Donations(self):
        self.donationgui = Toplevel(window)
        self.donationgui.title("dznvBlox (Donations)")
...
'''
    ...
    def _ViewStats(self):
        ...
        self.statsgui.title("dznvBlox (Stats)")
    ...
    def _Updatemesssage(self):
        if os.path.exists("data/Updatemessage.txt"):
            ...
            if "boogaboogaooo" in m:
                ...
                messagebox.showinfo("dznvBlox",f"{m}")
...
if is_admin():
    ...
    messagebox.showerror("dznvBlox","Admin privileges are required to use dznvBlox. Please run START.bat")